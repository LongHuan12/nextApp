const SearchFilters = () => {
    return (
        <div
            ...
            <div className="p-2">
                <div className="cursor-pointer p-2 lg:p-4 bg-blue-500 hover:bg-blue-700 transition-all duration-300 ease-in-out rounded-full text-white hover:shadow-lg hover:scale-105">
                    <svg
                        viewBox="0 0 32 32"
